...
void drawRects(){
  ...
  for(j=0; j<pixelX ; j+=1){
    if (j%density == 0){
      float randX = random(marginX, marginX+(rectW/2));
      noStroke();
      fill(255);
   ...
   if (j%density == stagger){
     float randXX = random(marginX, marginX+(rectW/2));
      noStroke();
      fill(0);
      ellipse(randXX,marginY*3+rectH*2, pixelSize*2, pixelSize*2);
      ellipse(randXX,marginY*3+rectH*3, pixelSize*2, pixelSize*2);
      ellipse(randXX,marginY*2+rectH*2, pixelSize*2, pixelSize*2);
      ellipse(randXX,marginY-19+rectH*2, pixelSize*2, pixelSize*2);
      fill(255);
